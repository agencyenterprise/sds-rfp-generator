...
const mockRFPs: RFP[] = [
  {
    ...
    data: {
      ...
      deadline: new Date("2024-10-29").toISOString(),
  ...
  },
  {
    ...
    data: {
      ...
      deadline: new Date("2024-10-28").toISOString(),
      company: "ABAAD",
      contactEmail: "test@test.com",
  ...
  },
  {
    ...
    data: {
      ...
      deadline: new Date("2024-10-24").toISOString(),
  ...
  },
  {
    ...
    data: {
      ...
      budget: "$25,000 - $50,000",
      category: "Legal",
      deadline: new Date("2024-10-30").toISOString(),
      company: "BRAC",
      contactEmail: "test@test.com",
